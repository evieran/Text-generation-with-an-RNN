...
# use batch method to convert into desired size
...
# Function that takes a sequence as input, duplicates, and shifts it to align the input and label for each timestep
...
# sampled_indices gives us, at each timestamp, a prediction of the next character index
...
# run this on loop to generate some text
start = time.time()
states = None
...
# calculate the updates and apply them to the model using optimizer
...
# optional - allows you to change the behavior of the train step
...
# If you need more control write your own custom training loop
EPOCHS = 10
